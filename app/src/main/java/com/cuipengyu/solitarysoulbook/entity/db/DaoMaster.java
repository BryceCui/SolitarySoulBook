...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(Database db, boolean ifNotExists) {
        ...
        UserHisitoryBeanDao.createTable(db, ifNotExists);
        UserInforMationDao.createTable(db, ifNotExists);
        UserShelfBeanDao.createTable(db, ifNotExists);
    }

    /** Drops underlying database table using DAOs. */
    public static void dropAllTables(Database db, boolean ifExists) {
        UserBeanDao.dropTable(db, ifExists);
        UserHisitoryBeanDao.dropTable(db, ifExists);
        UserInforMationDao.dropTable(db, ifExists);
        UserShelfBeanDao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(Database db) {
        ...
        registerDaoClass(UserHisitoryBeanDao.class);
        registerDaoClass(UserInforMationDao.class);
        registerDaoClass(UserShelfBeanDao.class);
    }
