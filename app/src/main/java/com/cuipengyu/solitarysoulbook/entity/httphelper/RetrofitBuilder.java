...
public class RetrofitBuilder implements HttpEngine {
    ...
    private static RetrofitBuilder mHelper;
    ...
    //选择baseurl
    public RetrofitBuilder(int check) {
        switch (check) {
            case 0:
    ...
    public static RetrofitBuilder build() {
        if (mHelper == null) return mHelper = new RetrofitBuilder();
        return mHelper;
    }
    public static RetrofitBuilder build(int index) {
        if (mHelper == null) return mHelper = new RetrofitBuilder(index);
        return mHelper;
    }
