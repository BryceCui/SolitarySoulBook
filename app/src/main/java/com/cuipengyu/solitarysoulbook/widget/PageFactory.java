...
public class PageFactory {
    ...
    private List<ChapterLink.MixTocBean.ChaptersBean> chaptersList;
    private int chapterSize = 0;
    private int currentPage = 1;
    private OnReadStateChangeListener listener;
    private String charset = "UTF-8";

    public PageFactory(Context context, String bookId, List<ChapterLink.MixTocBean.ChaptersBean> chaptersList) {
        this(context, ScreenUtil.getAppWidth(), ScreenUtil.getAppHeight(),
    ...
    public PageFactory(Context context, int width, int height, int fontSize, String bookId,
                       List<ChapterLink.MixTocBean.ChaptersBean> chaptersList) {
        mContext = context;
        mWidth = width;
        mHeight = height;
        mFontSize = fontSize;
...
//        mPaint.setTextSize(ContextCompat.getColor(context, R.color.chapter_content_day));
        ...
        mTitlePaint.setColor(ContextCompat.getColor(ApplicationContextUtil.getAppConnect(), R.color.dark_red));
